        ...
        <ul class="nav nav-tabs">
            ...
            <div class="buttons">
                    <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'eCliente')){
                        echo '<a title="Icon Title" class="btn btn-mini btn-info" href="'.base_url().'index.php/clientes/editar/'.$result->id_categoria.'"><i class="icon-pencil icon-white"></i> Editar</a>'; 
                    } ?>
                                    ...
                                    <div class="widget-content">
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td style="text-align: right"><strong>Razão Social</strong></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $result->data_nascimento ?></td>
                                                </tr>
                                                <tr>
