                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    ...
                                    <div class="span12" style="padding: 1%">
                                        ...
                                        <div class="span2">
                                            <label for="dataInicial">Data da Venda<span class="required">*</span></label>
                                            <input id="data_venda" class="span12 datepicker" type="text" name="data_venda" value="<?php echo date('d/m/Y'); ?>" <?php echo ($id_status_caixa == 1)?'':' disabled="" '; ?>  />
                                        </div>
                                        <div class="span5">
                                            <label for="cliente">Cliente<span class="required">*</span></label>
                                            <input id="cliente" class="span12" type="text" name="cliente" value="" <?php echo ($id_status_caixa == 1)?'':' disabled="" '; ?>  />
                                            <input id="id_cliente" class="span12" type="hidden" name="id_cliente" value=""  />
                                        </div>
                                        <div class="span5">
                                            <label for="tecnico">Vendedor<span class="required">*</span></label>
                                            <input id="tecnico" class="span12" type="text" name="tecnico" value="" <?php echo ($id_status_caixa == 1)?'':' disabled="" '; ?>  />
                                            <input id="id_usuario" class="span12" type="hidden" name="id_usuario" value=""  />
                                        </div>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6 offset3" style="text-align: center">
                                             <?php if ($id_status_caixa == 1) { ?>
                                            <button class="btn btn-success" id="btnContinuar" title="Dar continuidade a venda"><i class="icon-share-alt icon-white"></i> Continuar</button>
                                            <?php
                                                }
                                            ?>
                                            <a href="<?php echo base_url() ?>index.php/vendas" class="btn" title="Voltar a listagem de venda"><i class="icon-arrow-left"></i> Voltar</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
