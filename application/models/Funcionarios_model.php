...
class Funcionarios_model extends CI_Model {
    ...
    function get($table,$fields,$where='',$perpage=0,$start=0,$one=false,$array='array') {
        ...
        $this->db->from($table);
        $this->db->join('pessoa_fisica', 'pessoa_fisica.id_pessoa_fisica = funcionario.id_pessoa_fisica');
        $this->db->join('pessoa p ', 'p.id_pessoa = pessoa_fisica.id_pessoa');
    ...
    function getById($id) {
        ...
        $this->db->join('pessoa_fisica', 'pessoa_fisica.id_pessoa_fisica = funcionario.id_pessoa_fisica');
        $this->db->join('pessoa', 'pessoa.id_pessoa = pessoa_fisica.id_pessoa');
